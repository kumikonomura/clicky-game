...
class App extends React.Component {
  state = {
    ...
    score: 0,
    topScore: 0,
    greetingMessage: "Click an image to begin!"
  };
  ...
  handleClick = selectedCard => {
    ...
    if (this.state.selected.indexOf(imgUrl) < 0) {
      ...
      this.setState({
        ...
        greetingMessage: "You guessed correctly!"
      });
      ...
      // notify user that they have won the game
      window.alert("You win!!");
    } else {
      // if imgUrl WAS found in the selected array
      // reset state
      this.setState({
        selected: [],
        score: 0,
        greetingMessage: "You guessed incorrectly!"
      });
      // notify user of loss
